var VuePicker = (function (exports, vue) {
  ...
  function useDropdown () {
    ...
    var outClickTarget = vue.ref();

    var dropdown = new Dropdown(isShown, outClickTarget);
  ...
  var Dropdown = function Dropdown (isShown, outClickTarget) {
  ...
  var script$1 = {
    ...
    setup: function setup (props, ref$1) {
      ...
      vue.onMounted(function () {
        registerActions({
          toggleDropdown: function () { return dropdown.toggle(); },
          hideDropdown: function () { return dropdown.hide(); },
          selectFirst: function () { return selectFirst(); },
          selectLast: function () { return selectLast(); },
          selectPrev: function () { return selectPrev(); },
          selectNext: function () { return selectNext(); },
        });
      ...
      var emitCurOptVal = function (val) {
    ...
    return (vue.openBlock(), vue.createBlock("div", {
      ...
      vue.createVNode("button", {
        ...
        onKeydown: [
          ...
          _cache[3] || (_cache[3] = vue.withKeys(vue.withModifiers(function ($event) { return ($setup.selectPrev($event)); }, ["exact","stop","prevent"]), ["up"])),
          _cache[4] || (_cache[4] = vue.withKeys(vue.withModifiers(function ($event) { return ($setup.dropdown.toggle($event)); }, ["alt","stop","prevent"]), ["down"])),
          _cache[5] || (_cache[5] = vue.withKeys(vue.withModifiers(function ($event) { return ($setup.selectNext($event)); }, ["exact","stop","prevent"]), ["down"])),
          _cache[6] || (_cache[6] = vue.withKeys(vue.withModifiers(function ($event) { return ($setup.selectFirst($event)); }, ["stop","prevent"]), ["home"])),
          _cache[7] || (_cache[7] = vue.withKeys(vue.withModifiers(function ($event) { return ($setup.selectLast($event)); }, ["stop","prevent"]), ["end"]))
        ],
        disabled: $props.isDisabled,
        ref: "openerRef"
      }, [
        vue.renderSlot(_ctx.$slots, "opener", {
          opener: { value: $props.modelValue, text: $setup.openerTxt, opt: $setup.curOpt }
        }, function () { return [

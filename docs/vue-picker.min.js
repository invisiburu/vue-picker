var VuePicker = (function (exports, vue) {
  ...
  var script$1 = {
    ...
    setup: function setup (props, ref$1) {
      ...
      vue.onMounted(function () {
        registerActions({
          ...
          selectFirst: function () { options.selectFirst(); },
          selectLast: function () { options.selectLast(); },
          selectPrev: function () { options.selectPrev(); },
          selectNext: function () { options.selectNext(); },
        });
   ...
   options.selectByValue(value); },
        regOpt: function (opt) { options.registerOption(opt); },
        hideDropdown: function () { dropdown.hide(); },
      });
